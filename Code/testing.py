...
lab:Experiment = Experiment(experiment_path,True,False)

lab.HGA(env,constructive,genetic,instance,300,process_time(),True,rd_seed)
# lab.experiment(instance,configs)
